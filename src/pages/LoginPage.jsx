...
export default function LoginPage() {
    ...
    return (
        <div className="mt-4 mb-4 row mt-3">
            <h1 className="col-6 offset-3">Login on Marriage Hall</h1>
            <div className=" col-6 offset-3">
                ...
                <form noValidate className="needs-validation" onSubmit={handleSubmit}>
                    ...
                    <div className="mb-3 form-group">
                        ...
                        <input type={showPassword ? "text" : "password"} className="form-control" id="password" required value={password} onChange={(e) => setPassword(e.target.value)} />
                        <button
                            type="button"
